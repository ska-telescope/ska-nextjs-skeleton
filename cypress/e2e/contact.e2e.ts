...
context("Contact Page", () => {
  ...
  it("name and message changed render should generate errors and submit button disbled", () => {
    ...
    cy.get("span")
      .eq(5)
      .should("have.text", "String must contain at least 150 character(s)");
  ...
  it("valid input render should not generate errors and submit button enabled", () => {
    ...
    cy.get("textarea")
      .type(
        "This is a very long message which is longer than 150 characters, This field is to prevent the validation of message section of the field to generate validation eeror",
      )
      .trigger("change");
