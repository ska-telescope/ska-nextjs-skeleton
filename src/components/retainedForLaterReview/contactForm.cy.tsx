...
describe('<FormError />', () => {
  it('renders should have appropriate components', () => {
    ...
    cy.get('input').eq(0).should('have.attr', 'class', 'input input-bordered w-full max-w-xs');
    ...
    cy.get('input').eq(1).should('have.attr', 'class', 'input input-bordered w-full max-w-xs');
    ...
    cy.get('textarea').should('have.attr', 'class', 'textarea textarea-bordered h-24');
