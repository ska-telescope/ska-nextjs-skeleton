        ...
        <Grid p={1} container direction="row" alignItems="space-evenly" justifyContent="space-around" >
          <Grid item xs={5}>
            <Grid container direction="column" alignItems="flex-start" justifyContent="space-around">
              ...
              <DataGridWrapper rows={data.Observation.list} extendedColumns={extendedColumnsObservations} height={450} rowClick={ClickFunction} />
            </Grid>
          </Grid>
          <Grid item xs={7}>
            <Card variant='outlined'>
              <CardHeader
                ...
                title={<Typography variant='h6'>Target List related to the selected Observation</Typography>} />
              <CardContent>
                <FormControlLabel
                  value="linked"
                  control={
                ...
                <FormControlLabel
                  ...
                  sx={{ '& .MuiSvgIcon-root': { fontSize: 28 } }}
                />
                <DataGridWrapper rows={data.Targets.ListOfTargets.TargetItems} extendedColumns={extendedColumnsTargets} height={350} rowClick={ClickFunction} />
              </CardContent>
            </Card>
          </Grid>
        </Grid>
